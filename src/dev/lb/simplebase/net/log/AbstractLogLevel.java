 ...
 * to create any other level with {@link CustomLogLevel#}.
...
public interface AbstractLogLevel {
	 ...
	 * priority than lower levels (e.g. {@link LogLevel#DEBUG}). Many {@link AbstractLogger} implementations
	 ...
	 * Can be used by {@link AbstractLogger} implementations to decide whether to display
