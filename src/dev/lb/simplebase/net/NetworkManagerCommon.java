...
public abstract class NetworkManagerCommon {
	...
	//Instance inner class, 1:1 relation to the NetworkManagerCommon
	@Threadsafe
	@Internal
	private class PacketIDMappingContainerHash implements PacketIDMappingContainer {

		private final Set<PacketIDMapping> mappings;
		
		private PacketIDMappingContainerHash() {
